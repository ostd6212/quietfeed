...
[
  {{
    "score": <число 1-10>,
    "tags": ["<2-5 коротких тегів про компанію: сфера/домен, бізнес-модель, технології -- напр. iGaming, Fintech, Blockchain, SaaS, AI, B2B, Healthcare. Усталеними англомовними термінами, кожен тег 1-2 слова, без пояснень>"],
    "role_type": "<тип ролі>",
